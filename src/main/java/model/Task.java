...
public class Task {
    ...
    private boolean isCompleted; // 0 - nao completa --- 1 - completa (no bonco de dados)
    ...
    public Task(){
        this.createdAt = new Date();  //quando criar a tarefa, e nao passar o parametro, a data de criação vai ser o instante que foi criado
